...
export default {
  ...
  data () {
    return {
      ...
      tableData: [{
                 username:'小红',
                 accumulative_mem_package:2356,
                 avaliable_mem_package:562,
               }, {
                 username:'浩明',
                 accumulative_mem_package:56,
                 avaliable_mem_package:5,
               }, {
                 username:'偶记',
                 accumulative_mem_package:236,
                 avaliable_mem_package:52,
               }, {
                 username:'费红',
                 accumulative_mem_package:256,
                 avaliable_mem_package:52,
               }]
    }
  },
